...
<div class="modal-dialog">
	<div class="modal-content animated bounceInRight">
		<div class="modal-header">
			...
			<h1 class="modal-title" style="text-align: -webkit-left;">授权用户</h1>
		</div>
...
<!--                         <p class="small"><i class="fa fa-hand-o-up"></i> 在列表之间拖动面板</p> -->
                        ...
                        <div class="input-group">
                            <input type="text" placeholder="查询用户" class="input input-sm form-control" id="queryUser">
                            <span class="input-group-btn">
                                        <button type="button" onclick="queryUser();" class="btn btn-sm btn-white"> <i class="fa fa-plus"></i> 查询</button>
                                </span>
                        </div>
