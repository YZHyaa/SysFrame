...
<body class="gray-bg">
	...
	<script type="text/javascript">
		...
		function toAdd(){
			window.location.href="<%=basePath%>systemConstant/toAdd";
		}
		...
		function toEdit(){
			...
			window.location.href="<%=basePath%>systemConstant/toEdit?SC_ID="+ids[0];
		}
		...
		function toDel(){
			...
			layer.confirm('确认删除已选系统常量吗？',{btn:['确认','取消'],shade:false},function(){
				$.ajax({
					type: "POST",
					url: 'systemConstant/delete?tm='+ new Date().getTime(),
					data : {
						IDS : idsStr
					},
					dataType : 'json',
