...
<div class="row-fluid">
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		<script type="text/javascript" src="static/js/bootbox.min.js?v=20170904"></script><!-- 确认窗口 -->
		<!-- 引入 -->
		
		<script type="text/javascript" src="static/js/jquery.tips.js?v=20170904"></script><!--提示框-->
