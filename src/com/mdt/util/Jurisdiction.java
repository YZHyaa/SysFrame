...
public class Jurisdiction {
     ...
     * @return
     */
    public static boolean shiroJurisdiction(String menuUrl) {
        ...
        if ("admin".equals(userName))
            ...
            menuUrl = menuUrl.split(".do")[0];

            if (Const.MENUCACHE.isKeyInCache(menuUrl))
                return currentUser.isPermitted("url:" + menuUrl);
            else
                return true;
