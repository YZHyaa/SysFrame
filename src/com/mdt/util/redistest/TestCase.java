...
//		JedisUtil.getPool().destroy();
	...
	public void testListStrUsage() {
		...
		long adInfoId = jedis.incr("ad:adinfo:next");jedis.incr("ad:adinfo:next.id");
		...
		String resultTitle = jedis.get("ad:adinfo:next.id");
		String resultTitle2 = jedis.get("ad:adinfo:next");
	...
	//redis-server
	//redis-cli lpush hasnotshow "444"
	public String getNewMsg() {
		Jedis jedis = JedisUtil.getJedis();
//		jedis.flushAll();
		List<String> hasnotshow = jedis.lrange("hasshow", 0, -1);
		System.out.println(hasnotshow);
		List<String> hasshow = jedis.lrange("hasnotshow", 0, -1);
		System.out.println(hasshow);
		return jedis.brpoplpush("hasnotshow", "hasshow", 0).toString();
	}
